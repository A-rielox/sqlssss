...
DROP TABLE IF EXISTS DatingAppSql21012024.dbo.AppUsers;
...
INSERT INTO [dbo].[AppUsers] (UserName, Gender, DateOfBirth, KnownAs, Created, LastActive, Introduction, LookingFor, Interests, City, Country, PasswordHash, Email, NormalizedEmail)
VALUES	('Admin', 'male', '1980-05-01', 'Admin', '1980-05-01', '1980-05-01', '...', '...', '...', '...', '...', @Hash, 'Admin', 'ADMIN' ),
...
--TRUNCATE TABLE DatingAppSql21012024.dbo.AppUsers;
SELECT * FROM AppUsers;
